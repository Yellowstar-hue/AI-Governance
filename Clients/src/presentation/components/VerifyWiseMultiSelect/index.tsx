...
export interface AISafeMultiSelectOption {
  value: string;
  label: string;
}

export interface AISafeMultiSelectProps {
  options: AISafeMultiSelectOption[];
...
const AISafeMultiSelect: React.FC<AISafeMultiSelectProps> = ({
  options,
  selectedValues,
  onChange,
...
export default AISafeMultiSelect;