...
export const notificationsContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'AISafe provides notification capabilities to keep you informed about important governance activities. Notifications help ensure that team members are aware of updates, deadlines, and actions that require attention.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'AISafe can notify you about various governance events:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'The primary way to receive notifications from AISafe is through the Slack integration. When configured, AISafe can send real-time notifications directly to your Slack workspace.',
    },
    {
      type: 'paragraph',
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Authorize AISafe to connect to your Slack workspace' },
    ...
    {
      type: 'paragraph',
      text: 'In addition to external notifications, AISafe displays visual indicators within the platform to highlight items needing attention:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    },
    {
      ...
      level: 3,
      text: 'Does AISafe send email notifications?',
    },
    {
      type: 'paragraph',
      text: 'Currently, AISafe uses Slack as the primary notification channel. Email is used for account-related communications like invitations and password resets, but not for governance notifications.',
    },
    {
      type: 'heading',
