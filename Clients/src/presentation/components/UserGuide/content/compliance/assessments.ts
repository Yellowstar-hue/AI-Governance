...
export const assessmentsContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'AISafe supports multiple compliance frameworks to help you meet regulatory requirements and demonstrate responsible AI governance. Each framework provides a structured approach to evaluating your AI systems against specific standards or regulations.',
    },
    {
      type: 'paragraph',
      text: 'Rather than treating compliance as a one-time event, AISafe enables continuous assessment and improvement. You can track progress over time, identify gaps, and demonstrate to auditors exactly where you stand on each requirement.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'AISafe includes support for the following compliance frameworks:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'To begin compliance tracking in AISafe:',
    },
    {
      type: 'ordered-list',
      items: [
        ...
        { text: 'AISafe creates an assessment with all applicable requirements' },
    ...
    {
      type: 'paragraph',
      text: 'While each framework has its own structure and terminology, they share common elements in AISafe:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Compliance is not a one-time achievement. AISafe supports ongoing compliance management:',
    },
    {
      type: 'bullet-list',
      items: [
