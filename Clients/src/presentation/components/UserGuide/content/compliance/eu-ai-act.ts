...
export const euAiActContent: ArticleContent = {
  blocks: [
    ...
    },
    {
      ...
      id: 'aisafe-support',
      level: 2,
      text: 'How AISafe supports EU AI Act compliance',
    },
    {
      type: 'paragraph',
      text: 'AISafe provides structured tools to help you meet EU AI Act requirements:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'To begin your EU AI Act compliance journey in AISafe:',
    },
    {
      type: 'ordered-list',
      items: [
        { text: 'Create a use case for your AI system in AISafe' },
    ...
    {
      type: 'paragraph',
      text: 'AISafe organizes EU AI Act requirements into manageable controls and subcontrols:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'When you select the EU AI Act framework for a use case, AISafe creates an assessment containing all applicable controls. The assessment screen provides a comprehensive view of your compliance progress.',
    },
    {
      type: 'paragraph',
    ...
    {
      type: 'paragraph',
      text: 'EU AI Act controls in AISafe are organized into categories aligned with the regulation\'s structure:',
    },
    {
      type: 'checklist',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'AISafe provides multiple ways to monitor your EU AI Act compliance progress:',
    },
    {
      type: 'bullet-list',
      items: [
