...
export const welcomeContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: "AISafe is an enterprise-ready AI governance platform that helps organizations manage AI systems safely and responsibly. Whether you're tracking AI models, managing compliance with regulations like the EU AI Act, or monitoring vendor risks, AISafe provides the tools you need to bring order to your AI governance program.",
    },
    {
      type: 'paragraph',
    ...
    },
    {
      type: 'callout',
      variant: 'info',
      text: 'AISafe is source-available software, which means you can review the code, deploy it internally, and maintain full visibility into how your governance platform operates.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: "AISafe centralizes your AI governance activities in one platform. Here's what you can accomplish:",
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'AISafe provides built-in support for major AI governance and information security frameworks:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Beyond core governance capabilities, AISafe includes features designed to streamline your workflow:',
    },
    {
      type: 'checklist',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'AISafe is designed for flexible deployment to match your infrastructure requirements:',
    },
    {
      type: 'grid-cards',
      items: [
    ...
    },
    {
      type: 'ordered-list',
      items: [
        { bold: 'Install AISafe', text: '— Follow our installation guide to deploy the platform in your environment' },
