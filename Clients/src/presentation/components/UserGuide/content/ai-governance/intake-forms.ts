...
export const intakeFormsContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Intake forms let anyone in your organization request a new AI use case or register a model without needing a AISafe account. You publish a public form, share the link, and submissions land in your governance queue for review. When you approve a submission, AISafe creates the use case or model inventory entry and carries over the risk score from the intake.',
    },
    {
      type: 'paragraph',
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Click **Approve**. AISafe creates the entity (use case or model inventory entry) with the confirmed data.' },
