...
export const useCasesContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'From your answers, AISafe calculates a risk level (High, Medium, or Low) and flags the compliance requirements that apply. A system processing personal data, for instance, gets GDPR and DPIA requirements added automatically.',
    },
    {
      type: 'heading',
