...
export const aiDetectionSettingsContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Paste your token into the **Personal access token** field. Optionally give it a descriptive name (e.g., "AISafe Scanner Token") to help identify it later. Click **Test token** to verify it works, then **Save token** to store it.',
    },
    {
      type: 'heading',
      id: 'managing-token',
