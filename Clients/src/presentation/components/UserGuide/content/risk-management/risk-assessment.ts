...
export const riskAssessmentContent: ArticleContent = {
  blocks: [
    ...
    },
    {
      type: 'callout',
      variant: 'info',
      text: 'Risks in AISafe can be linked to both use cases and compliance frameworks, allowing you to track risks across different contexts and regulatory requirements.',
    },
    {
      type: 'image',
    ...
    {
      type: 'paragraph',
      text: 'To create a new risk in AISafe, navigate to the Risk Management section and provide the following information:',
    },
    {
      type: 'ordered-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'AISafe tracks risks across the complete AI system lifecycle:',
    },
    {
      type: 'icon-cards',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'Each risk is analyzed using likelihood and severity assessments. AISafe automatically calculates the overall risk level based on these inputs.',
    },
    {
      type: 'heading',
    ...
    {
      type: 'paragraph',
      text: 'Based on likelihood and severity, AISafe automatically calculates the risk level:',
    },
    {
      type: 'table',
      columns: [
    ...
    {
      type: 'paragraph',
      text: 'AISafe provides several views for monitoring your risks:',
    },
    {
      type: 'bullet-list',
      items: [
