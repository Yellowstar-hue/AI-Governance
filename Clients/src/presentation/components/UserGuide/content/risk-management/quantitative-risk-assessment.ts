...
export const quantitativeRiskAssessmentContent: ArticleContent = {
  blocks: [
    ...
    {
      type: 'paragraph',
      text: 'Once enabled, every risk gains a Quantitative tab. You enter event frequency, loss estimates across four categories, control effectiveness, and mitigation cost. AISafe runs the math in real time and shows your Annualized Loss Expectancy, residual exposure, and ROI right at the top of the form.',
    },
    {
      type: 'callout',
      variant: 'info',
    ...
    {
      type: 'paragraph',
      text: 'FAIR is a widely adopted framework for expressing risk in monetary terms. AISafe uses a simplified version built around four calculations:',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    {
      type: 'paragraph',
      text: 'You do not have to estimate from zero. Pick an industry benchmark from the dropdown and AISafe fills in all fifteen frequency and loss fields for you. There are 19 benchmarks across six industries, drawn from published regulatory penalty data and incident reports.',
    },
    {
      type: 'bullet-list',
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        { bold: 'Annual mitigation cost', text: 'Enter what you spend each year on the controls. AISafe uses this to calculate whether the investment pays for itself.' },
      ],
    },
    {
      type: 'callout',
