...
const SidebarFooter: FC<SidebarFooterProps> = ({
  ...
  const { userId, users, photoRefreshFlag } = useContext(AISafeContext);
            ...
            <Stack spacing={2}>
              ...
              <Box>
                ...
                <Stack spacing={1}>
                  ...
                  <ListItemButton
                    onClick={() => {
                      if (openUserGuide) {
                        ...
                        window.open("https://aisafe.ai", "_blank", "noreferrer");
                      }
                      closePopup();
                    }}
                    sx={{
                  ...
                  <ListItemButton
                    onClick={() => {
                      window.open("https://aisafe.ai/blog", "_blank", "noreferrer");
                      closePopup();
                    }}
                    sx={{
                      height: "32px",
                  ...
                  <ListItemButton
                    onClick={() => {
                      window.open("https://aisafe.ai/contact", "_blank", "noreferrer");
                      closePopup();
                    }}
                    sx={{
                      height: "32px",
