...
const FRAMEWORK_SELECTED_KEY = "aisafe_framework_selected";
const ISO27001_TAB_KEY = "aisafe_iso27001_tab";
const ISO42001_TAB_KEY = "aisafe_iso42001_tab";
const NIST_AI_RMF_TAB_KEY = "aisafe_nist_ai_rmf_tab";
...
const DASHBOARD_TAB_STORAGE_KEY = "aisafe_dashboard_active_tab";
