...
transition: "none"                     // Disabled (buttons, ripple)`,
  noTransition: `// AISafe disables transitions on interactive elements
  ...
  return (
    <Box sx={{ p: "32px 40px" }}>
      ...
      <Box sx={{ mb: "32px" }}>
        ...
        >
          AISafe uses subtle, fast transitions. Most button interactions have
      ...
      <SpecSection title="Disabled transitions">
        <Typography sx={{ fontSize: 13, color: theme.palette.text.tertiary, mb: "24px" }}>
          AISafe intentionally disables transitions on buttons and interactive
