    ...
    <Box sx={{ p: "32px 40px" }}>
      ...
      <Box sx={{ mb: "32px" }}>
        ...
        >
          ...
          to ensure AISafe is usable by everyone.
        </Typography>
      </Box>
      ...
      >
        ...
        <Typography sx={{ fontSize: 11, color: theme.palette.text.tertiary, mt: "16px" }}>
          Items with ✓ are required for AISafe. Test with screen readers (VoiceOver, NVDA) regularly.
        </Typography>
      </Box>
    </Box>
  );
