...
const GS_CARDS = [
  {
    ...
    url: "https://aisafe.ai/user-guide",
  },
  {
    ...
    url: "https://aisafe.ai/user-guide/getting-started/quick-start",
  },
  {
    ...
    action: "external" as const,
    url: "https://aisafe.ai/user-guide/getting-started/dashboard",
  },
  {
    title: "Installing AISafe",
    desc: "Step-by-step guide to deploy AISafe in your environment.",
    image: "https://images.unsplash.com/photo-1501854140801-50d01698950b?w=600&q=80",
    overlay: "linear-gradient(135deg, rgba(230,81,0,0.82), rgba(244,81,30,0.72))",
    action: "external" as const,
    url: "https://aisafe.ai/user-guide/getting-started/installing",
  },
] as const;
...
const RESOURCES = [
  { label: "User guide", sub: "aisafe.ai/user-guide", icon: BookOpen, url: "https://aisafe.ai/user-guide" },
  { label: "Blog", sub: "aisafe.ai/blog", icon: Newspaper, url: "https://aisafe.ai/blog" },
  { label: "API documentation", sub: "aisafe.ai/api-docs", icon: Plug, url: "https://aisafe.ai/api-docs" },
  { label: "Community", sub: "github.com/bluewave-labs/aisafe", icon: MessageCircle, url: "https://github.com/bluewave-labs/aisafe" },
] as const;

const WHATS_NEW = [
  { label: "AI regulation in the Middle East", sub: "Mar 17, 2026", url: "https://aisafe.ai/blog/ai-regulation-middle-east" },
  { label: "AI governance directory", sub: "Feb 22, 2026", url: "https://aisafe.ai/blog/list-your-ai-governance-company-on-aisafe-directory" },
  { label: "Shadow AI detection", sub: "Feb 13, 2026", url: "https://aisafe.ai/blog/shadow-ai-detection-visibility-risk-scoring-governance" },
  { label: "EU AI Act deployer policy pack", sub: "Dec 23, 2025", url: "https://aisafe.ai/blog/eu-ai-act-deployer-policy-pack" },
] as const;
...
const PROGRESS_STORAGE_KEY = "aisafe_start_here_progress";
...
const StartHere = () => {
  ...
  const [progressDismissed, setProgressDismissed] = useState(
    () => localStorage.getItem("aisafe_start_here_progress_dismissed") === "true"
  );
  const [welcomeVideoOpen, setWelcomeVideoOpen] = useState(false);
  const [expertsDismissed, setExpertsDismissed] = useState(
    () => localStorage.getItem("aisafe_start_here_experts_dismissed") === "true"
  );
  ...
  useEffect(() => {
    ...
    const confettiFiredKey = "aisafe_start_here_confetti_fired";
  ...
  const dismissProgress = useCallback(() => {
    localStorage.setItem("aisafe_start_here_progress_dismissed", "true");
      ...
      <Stack sx={{ gap: "32px", minWidth: 0 }}>
        ...
        <Box sx={{ animation: `${fadeInUp} 0.5s ease-out 0.4s both` }}>
          ...
          <Stack direction="row" alignItems="flex-start" sx={{ gap: "12px", position: "relative", width: "fit-content" }}>
            {[
              { name: "Ulas Ozguven", photo: "https://aisafe.ai/images/team/ulas.jpeg" },
              { name: "David Pinkney", photo: "https://aisafe.ai/images/avatars/DavidPinkney.jpg" },
            ].map((expert) => (
              <Stack
                key={expert.name}
                onClick={() => window.open("https://aisafe.ai/contact", "_blank", "noopener,noreferrer")}
                alignItems="center"
                sx={{
                  gap: "8px",
                  p: "16px",
            ...
            <Typography
              onClick={(e) => {
                ...
                localStorage.setItem("aisafe_start_here_experts_dismissed", "true");
              }}
              sx={{
                position: "absolute",
                top: -24,
