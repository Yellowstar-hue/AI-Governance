...
const Dashboard: FC<DashboardProps> = ({ reloadTrigger }) => {
  const { setDashboardValues, setProjects } = useContext(AISafeContext);
      ...
      <AIDetectionSidebarProvider>
        ...
        >
          ...
          <StandardModal
            ...
            description="Generate sample data to explore AISafe features"
          ...
          >
            <Typography variant="body2" sx={{ color: "text.secondary" }}>
              ...
              explore AISafe. You can remove this demo data at any time.
            </Typography>
          </StandardModal>
