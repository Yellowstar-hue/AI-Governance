...
describe("useIsMultiTenant", () => {
  ...
  it("should return isMultiTenant=true when hostname is app.aisafe.ai", async () => {
    Object.defineProperty(window, "location", {
      value: { ...window.location, hostname: "app.aisafe.ai" },
      writable: true,
    });
    mockCheckOrganizationExists.mockResolvedValue(true);
  ...
  it("should return isMultiTenant=true when hostname is test.aisafe.ai", async () => {
    Object.defineProperty(window, "location", {
      value: { ...window.location, hostname: "test.aisafe.ai" },
      writable: true,
    });
    mockCheckOrganizationExists.mockResolvedValue(true);
