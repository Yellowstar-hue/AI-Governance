...
export const ENTITY_TIPS: EntityTips = {
  ...
  settings: [
    {
      header: "Settings customize AISafe to your organization's needs.",
  ...
  "ai-gateway-virtual-keys": [
    {
      ...
      content: "Create a virtual key, share it with a developer, and they swap their OpenAI base URL to the gateway. Every request flows through your guardrails, budget controls, and audit logs — without anyone needing a AISafe account.",
    },
    {
