...
export const MIGRATION_TABLE_ORDER = {
  // Level 0: No FK dependencies on other tenant tables (only references to aisafe schema)
  level0: [
    // Core entities
    'projects',
    'vendors',
 ...
 * These IDs should NOT be remapped - they reference aisafe schema struct data.
 */
...
/**
 * Table name mapping: old tenant table name -> new aisafe table name.
