    ...
    <mj-section>
      <mj-column>
        <mj-text>
          ...
          <p>Hello {{user_name}},</p>
          <p>This is a test email from AISafe using the {{provider_name}} provider.</p>
...
async function testProvider(
  ...
  try {
    ...
    const emailOptions: EmailOptions = {
      to: testEmail,
      subject: `AISafe Email Test - ${provider.getProviderName()}`,
      html: html,
    };
...
async function main() {
  console.log("🚀 AISafe Email Provider Test Suite");
  console.log("=====================================");
