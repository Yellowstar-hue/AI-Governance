...
export async function runAdvisor(req: Request, res: Response) {
  ...
  logStructured(
    "processing",
    "Getting AISafe advisor response",
    functionName,
    fileName,
  );
  logger.debug(" Getting AISafe advisor response");
  ...
  try {
    ...
    logStructured(
      "successful",
      "Getting AISafe advisor response successful",
      functionName,
      fileName,
    );
    ...
    logStructured(
      "error",
      "failed to get AISafe advisor response",
      functionName,
      fileName,
    );
    logger.error("❌ Error in getting AISafe advisor response:", error);
