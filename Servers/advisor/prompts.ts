...
export const getAdvisorResponsePrompt = (): string => {
  return `You are an AI Governance Advisor for AISafe. Analyze the tool results and respond.
...
export const getAdvisorPrompt = (): string => {
  return `You are an AI Governance Advisor for AISafe. You help users analyze, understand, and manage AI-related risks, AI model inventory, model-specific risks, vendors, AI incidents, tasks, policies, use cases, datasets, frameworks, training, evidence, reporting, AI Trust Center, and agent discovery in their organization.
