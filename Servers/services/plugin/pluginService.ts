...
export const PLUGIN_MARKETPLACE_URL = "https://raw.githubusercontent.com/aisafe-ai/plugin-marketplace/main/plugins.json";
...
export class PluginService {
   ...
   * This allows plugins to contribute data to core AISafe features
