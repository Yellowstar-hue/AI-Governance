...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.sequelize.query(`
        CREATE SCHEMA IF NOT EXISTS aisafe;
      `, { transaction });
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.projects_status_enum AS ENUM ('Not started', 'In progress', 'Under review', 'Completed', 'Closed', 'On hold', 'Rejected');
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projects_ai_risk_classification AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projects_type_of_high_risk_role AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_vendors_review_status AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_vendors_data_sensitivity AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_vendors_business_criticality AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_vendors_past_issues AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_vendors_regulatory_exposure AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_trainingregistar_status AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_event_logs_event_type AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projectrisks_ai_lifecycle_phase AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projectrisks_risk_category AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projectrisks_likelihood AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projectrisks_severity AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projectrisks_risk_level_autocalculated AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projectrisks_mitigation_status AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projectrisks_current_risk_level AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projectrisks_likelihood_mitigation AS ENUM (
            'Rare', 'Unlikely', 'Possible', 'Likely', 'Almost Certain'
          );
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_projectrisks_risk_severity AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_vendorrisks_likelihood AS ENUM (
            'Rare', 'Unlikely', 'Possible', 'Likely', 'Almost certain'
          );
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_vendorrisks_risk_severity AS ENUM (
            'Negligible', 'Minor', 'Moderate', 'Major', 'Catastrophic'
          );
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_files_source AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_controls_status AS ENUM ('Waiting', 'In progress', 'Done');
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      `, { transaction });
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_controls_risk_review AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_subcontrols_status AS ENUM ('Waiting', 'In progress', 'Done');
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      `, { transaction });
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_subcontrols_risk_review AS ENUM (
            'Acceptable risk', 'Residual risk', 'Unacceptable risk'
          );
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_status_questions AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_subclauses_iso_status AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_annexcategories_iso_status AS ENUM (
            'Not started', 'Draft', 'In progress', 'Awaiting review',
            'Awaiting approval', 'Implemented', 'Audited', 'Needs rework'
          );
        EXCEPTION WHEN duplicate_object THEN null;
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_model_inventories_status AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_model_risks_risk_category AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_model_risks_risk_level AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_model_risks_status AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_dataset_status AS ENUM ('Draft', 'Active', 'Deprecated', 'Archived');
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      `, { transaction });
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_dataset_type AS ENUM ('Training', 'Validation', 'Testing', 'Production', 'Reference');
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      `, { transaction });
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_data_classification AS ENUM ('Public', 'Internal', 'Confidential', 'Restricted');
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      `, { transaction });
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_tasks_priority AS ENUM ('Low', 'Medium', 'High');
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      `, { transaction });
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_tasks_status AS ENUM ('Open', 'In Progress', 'Completed', 'Overdue', 'Deleted');
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      `, { transaction });
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_notification_type AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_notification_entity_type AS ENUM (
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_llm_keys_provider AS ENUM ('Anthropic', 'OpenAI', 'OpenRouter', 'Custom');
        EXCEPTION WHEN duplicate_object THEN null;
        END $$;
      `, { transaction });
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_nist_ai_rmf_status AS ENUM (
            'Not started', 'Draft', 'In progress', 'Awaiting review',
      ...
      await queryInterface.sequelize.query(`
        DO $$ BEGIN
          CREATE TYPE aisafe.enum_nist_ai_rmf_subcategories_status AS ENUM (
            'Not started', 'Draft', 'In progress', 'Awaiting review',
            'Awaiting approval', 'Implemented', 'Needs rework', 'Audited'
          );
        EXCEPTION WHEN duplicate_object THEN null;
      ...
      await queryInterface.sequelize.query(`
        INSERT INTO aisafe.roles (id, name, description) VALUES
      ...
      // Reset sequence
      await queryInterface.sequelize.query(`
        SELECT setval('aisafe.roles_id_seq', (SELECT MAX(id) FROM aisafe.roles));
      `, { transaction });
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      // Drop roles table
      await queryInterface.sequelize.query(`DROP TABLE IF EXISTS aisafe.roles CASCADE;`, { transaction });
