...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable({ tableName: 'risk_portfolio_snapshots', schema: 'aisafe' }, {
      id: {
    ...
    await queryInterface.addIndex(
      { tableName: 'risk_portfolio_snapshots', schema: 'aisafe' },
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable({ tableName: 'risk_portfolio_snapshots', schema: 'aisafe' });
