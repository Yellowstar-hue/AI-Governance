  ...
  async up(queryInterface, Sequelize) {
    ...
    const createIndex = async (indexName, tableName, columns) => {
      await queryInterface.sequelize.query(`
        CREATE INDEX IF NOT EXISTS ${indexName} ON aisafe.${tableName}(${columns});
      `, { transaction });
    };
    ...
    // SEQUENCES
    // ========================================
    await queryInterface.sequelize.query(`CREATE SEQUENCE IF NOT EXISTS aisafe.project_uc_id_seq;`, { transaction });
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.projects (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        uc_id VARCHAR(255),
        project_title VARCHAR(255) NOT NULL,
        owner INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        start_date TIMESTAMP WITH TIME ZONE,
        ai_risk_classification aisafe.enum_projects_ai_risk_classification,
        type_of_high_risk_role aisafe.enum_projects_type_of_high_risk_role,
        goal TEXT,
        target_industry VARCHAR(255),
        description TEXT,
        geography INTEGER,
        last_updated TIMESTAMP WITH TIME ZONE,
        last_updated_by INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        is_demo BOOLEAN NOT NULL DEFAULT false,
        is_organizational BOOLEAN NOT NULL DEFAULT false,
        status aisafe.projects_status_enum NOT NULL DEFAULT 'Not started',
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.vendors (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        order_no INTEGER,
        vendor_name VARCHAR(255) NOT NULL,
        vendor_provides TEXT NOT NULL,
        assignee INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        website VARCHAR(255) NOT NULL,
        vendor_contact_person VARCHAR(255) NOT NULL,
        review_result VARCHAR(255),
        review_status aisafe.enum_vendors_review_status,
        reviewer INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        review_date TIMESTAMP WITH TIME ZONE,
        data_sensitivity aisafe.enum_vendors_data_sensitivity,
        business_criticality aisafe.enum_vendors_business_criticality,
        past_issues aisafe.enum_vendors_past_issues,
        regulatory_exposure aisafe.enum_vendors_regulatory_exposure,
        risk_score INTEGER,
        is_demo BOOLEAN NOT NULL DEFAULT false,
        created_at TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT now(),
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.trainingregistar (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        ...
        status aisafe.enum_trainingregistar_status,
        people INTEGER,
    ...
    // projects_members
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.projects_members (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        user_id INTEGER NOT NULL REFERENCES aisafe.users(id) ON DELETE CASCADE,
        project_id INTEGER NOT NULL REFERENCES aisafe.projects(id) ON DELETE CASCADE,
        is_demo BOOLEAN NOT NULL DEFAULT false,
    ...
    // event_logs
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.event_logs (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        event_type aisafe.enum_event_logs_event_type NOT NULL,
        description TEXT,
        user_id INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
    ...
    // vendors_projects
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.vendors_projects (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        vendor_id INTEGER NOT NULL REFERENCES aisafe.vendors(id) ON DELETE CASCADE,
        project_id INTEGER NOT NULL REFERENCES aisafe.projects(id) ON DELETE CASCADE,
        is_demo BOOLEAN NOT NULL DEFAULT false,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.risks (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        risk_name VARCHAR(255) NOT NULL,
        risk_owner INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        ai_lifecycle_phase aisafe.enum_projectrisks_ai_lifecycle_phase,
        risk_description TEXT,
        risk_category aisafe.enum_projectrisks_risk_category[],
        impact VARCHAR(255),
        assessment_mapping TEXT,
        controls_mapping TEXT,
        likelihood aisafe.enum_projectrisks_likelihood,
        severity aisafe.enum_projectrisks_severity,
        risk_level_autocalculated aisafe.enum_projectrisks_risk_level_autocalculated,
        review_notes TEXT,
        mitigation_status aisafe.enum_projectrisks_mitigation_status,
        current_risk_level aisafe.enum_projectrisks_current_risk_level,
        deadline TIMESTAMP WITH TIME ZONE,
        mitigation_plan TEXT,
        implementation_strategy TEXT,
        mitigation_evidence_document VARCHAR(255),
        likelihood_mitigation aisafe.enum_projectrisks_likelihood_mitigation,
        risk_severity aisafe.enum_projectrisks_risk_severity,
        final_risk_level VARCHAR(255),
        risk_approval INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.projects_risks (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        risk_id INTEGER NOT NULL REFERENCES aisafe.risks(id) ON DELETE CASCADE,
        project_id INTEGER NOT NULL REFERENCES aisafe.projects(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.frameworks_risks (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        risk_id INTEGER NOT NULL REFERENCES aisafe.risks(id) ON DELETE CASCADE,
        framework_id INTEGER NOT NULL REFERENCES aisafe.frameworks(id) ON DELETE CASCADE,
    ...
    // virtual_folders
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.virtual_folders (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        name VARCHAR(255) NOT NULL,
        description TEXT,
        parent_id INTEGER REFERENCES aisafe.virtual_folders(id) ON DELETE CASCADE,
        color VARCHAR(7),
        icon VARCHAR(50),
        is_system BOOLEAN DEFAULT FALSE,
        created_by INTEGER REFERENCES aisafe.users(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.file_folder_mappings (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        file_id INTEGER NOT NULL REFERENCES aisafe.files(id) ON DELETE CASCADE,
        folder_id INTEGER NOT NULL REFERENCES aisafe.virtual_folders(id) ON DELETE CASCADE,
        assigned_by INTEGER REFERENCES aisafe.users(id) ON DELETE CASCADE,
    ...
    // projects_frameworks
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.projects_frameworks (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        project_id INTEGER NOT NULL REFERENCES aisafe.projects(id) ON DELETE CASCADE,
        framework_id INTEGER NOT NULL REFERENCES aisafe.frameworks(id) ON DELETE CASCADE,
    ...
    // assessments
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.assessments (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        project_id INTEGER REFERENCES aisafe.projects(id) ON DELETE SET NULL,
        is_demo BOOLEAN NOT NULL DEFAULT false,
        created_at TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT now(),
        projects_frameworks_id INTEGER REFERENCES aisafe.projects_frameworks(id) ON DELETE CASCADE
      );
    `, { transaction });

    // projectscopes
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.projectscopes (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // vendorrisks
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.vendorrisks (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        vendor_id INTEGER REFERENCES aisafe.vendors(id) ON DELETE CASCADE,
        order_no INTEGER,
        risk_description TEXT,
        impact_description TEXT,
        likelihood aisafe.enum_vendorrisks_likelihood,
        risk_severity aisafe.enum_vendorrisks_risk_severity,
        action_plan TEXT,
        action_owner INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.controls_eu (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        status aisafe.enum_controls_status,
        approver INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        risk_review aisafe.enum_controls_risk_review,
        owner INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        reviewer INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        due_date TIMESTAMP WITH TIME ZONE,
        implementation_details TEXT,
        is_demo BOOLEAN NOT NULL DEFAULT false,
        control_meta_id INTEGER REFERENCES aisafe.controls_struct_eu(id) ON DELETE CASCADE,
        projects_frameworks_id INTEGER REFERENCES aisafe.projects_frameworks(id) ON DELETE CASCADE,
        created_at TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT now()
      );
    `, { transaction });
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.subcontrols_eu (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        status aisafe.enum_subcontrols_status,
        approver INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        risk_review aisafe.enum_subcontrols_risk_review,
        owner INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        reviewer INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        due_date TIMESTAMP WITH TIME ZONE,
        implementation_details TEXT,
        control_id INTEGER REFERENCES aisafe.controls_eu(id) ON DELETE CASCADE,
        subcontrol_meta_id INTEGER REFERENCES aisafe.subcontrols_struct_eu(id) ON DELETE CASCADE,
        is_demo BOOLEAN NOT NULL DEFAULT false,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.answers_eu (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        assessment_id INTEGER REFERENCES aisafe.assessments(id) ON DELETE CASCADE,
        question_id INTEGER REFERENCES aisafe.questions_struct_eu(id) ON DELETE CASCADE,
        answer TEXT,
        dropdown_options TEXT[],
        status aisafe.enum_status_questions DEFAULT 'Not started',
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.subcontrols_eu__risks (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        subcontrol_id INTEGER REFERENCES aisafe.subcontrols_eu(id) ON DELETE CASCADE,
        projects_risks_id INTEGER REFERENCES aisafe.risks(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.subclauses_iso (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        implementation_description TEXT,
        status aisafe.enum_subclauses_iso_status DEFAULT 'Not started',
        owner INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        reviewer INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        approver INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        due_date DATE,
        auditor_feedback TEXT,
        subclause_meta_id INTEGER REFERENCES aisafe.subclauses_struct_iso(id) ON DELETE CASCADE,
        projects_frameworks_id INTEGER REFERENCES aisafe.projects_frameworks(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.annexcategories_iso (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        is_applicable BOOLEAN DEFAULT false,
        justification_for_exclusion TEXT,
        implementation_description TEXT,
        status aisafe.enum_annexcategories_iso_status DEFAULT 'Not started',
        owner INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        reviewer INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        approver INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        due_date DATE,
        auditor_feedback TEXT,
        projects_frameworks_id INTEGER REFERENCES aisafe.projects_frameworks(id) ON DELETE CASCADE,
        annexcategory_meta_id INTEGER REFERENCES aisafe.annexcategories_struct_iso(id) ON DELETE CASCADE,
        created_at TIMESTAMP WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP,
        is_demo BOOLEAN DEFAULT false
      );
    `, { transaction });
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.annexcategories_iso__risks (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.subclauses_iso27001 (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        implementation_description TEXT,
        status aisafe.enum_subclauses_iso_status DEFAULT 'Not started',
        ...
        due_date DATE,
        auditor_feedback TEXT,
        subclause_meta_id INTEGER REFERENCES aisafe.subclauses_struct_iso27001(id) ON DELETE CASCADE,
        projects_frameworks_id INTEGER REFERENCES aisafe.projects_frameworks(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.annexcontrols_iso27001 (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        implementation_description TEXT,
        status aisafe.enum_annexcategories_iso_status DEFAULT 'Not started',
        ...
        auditor_feedback TEXT,
        projects_frameworks_id INTEGER REFERENCES aisafe.projects_frameworks(id) ON DELETE CASCADE,
        annexcontrol_meta_id INTEGER REFERENCES aisafe.annexcontrols_struct_iso27001(id) ON DELETE CASCADE,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        is_demo BOOLEAN DEFAULT FALSE
      );
    `, { transaction });
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.nist_ai_rmf_subcategories (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        subcategory_meta_id INTEGER REFERENCES aisafe.nist_ai_rmf_subcategories_struct(id) ON DELETE CASCADE,
        projects_frameworks_id INTEGER NOT NULL,
        implementation_description TEXT,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        updated_at TIMESTAMP,
        is_demo BOOLEAN DEFAULT FALSE,
        status aisafe.enum_nist_ai_rmf_subcategories_status DEFAULT 'Not started',
        auditor_feedback TEXT,
        owner INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        reviewer INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        approver INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
    ...
    // policy_manager
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.policy_manager (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        ...
        author_id INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        last_updated_by INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        last_updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
        review_status VARCHAR(50),
        review_comment TEXT,
        reviewed_by INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
    ...
    // model_inventories
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.model_inventories (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        ...
        status aisafe.enum_model_inventories_status DEFAULT 'Pending',
    ...
    // model_risks
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.model_risks (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        risk_name VARCHAR(255),
        risk_category aisafe.enum_model_risks_risk_category,
        risk_level aisafe.enum_model_risks_risk_level,
        status aisafe.enum_model_risks_status DEFAULT 'Open',
        owner INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        ...
        model_id INTEGER REFERENCES aisafe.model_inventories(id) ON DELETE CASCADE,
        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.datasets (
        ...
        version VARCHAR(50),
        owner VARCHAR(255),
        type aisafe.enum_dataset_type,
        function TEXT,
        source VARCHAR(255),
        license VARCHAR(255),
        format VARCHAR(100),
        classification aisafe.enum_data_classification,
        contains_pii BOOLEAN DEFAULT false,
        pii_types TEXT,
        status aisafe.enum_dataset_status DEFAULT 'Draft',
    ...
    // tasks
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.tasks (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        title VARCHAR(255) NOT NULL,
        description TEXT,
        creator_id INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        due_date TIMESTAMP WITH TIME ZONE,
        priority aisafe.enum_tasks_priority DEFAULT 'Medium',
        status aisafe.enum_tasks_status DEFAULT 'Open',
    ...
    // task_assignees
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.task_assignees (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        task_id INTEGER NOT NULL REFERENCES aisafe.tasks(id) ON DELETE CASCADE,
        user_id INTEGER NOT NULL REFERENCES aisafe.users(id) ON DELETE CASCADE,
        assigned_at TIMESTAMP WITH TIME ZONE DEFAULT now(),
        created_at TIMESTAMP WITH TIME ZONE DEFAULT now(),
        updated_at TIMESTAMP WITH TIME ZONE DEFAULT now(),
    ...
    await queryInterface.sequelize.query(`CREATE SEQUENCE IF NOT EXISTS aisafe.incident_id_seq;`, { transaction });
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.ai_incident_managements (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        incident_id VARCHAR(255) DEFAULT 'INC-' || nextval('aisafe.incident_id_seq'),
    ...
    // automations
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.automations (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        name TEXT NOT NULL,
        trigger_id INTEGER REFERENCES aisafe.automation_triggers(id) ON DELETE RESTRICT,
        params JSONB DEFAULT '{}',
        is_active BOOLEAN DEFAULT TRUE,
        created_by INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        created_at TIMESTAMP DEFAULT NOW()
      );
    `, { transaction });
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.automation_actions_data (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        automation_id INTEGER REFERENCES aisafe.automations(id) ON DELETE CASCADE,
        action_type_id INTEGER REFERENCES aisafe.automation_actions(id) ON DELETE RESTRICT,
        params JSONB DEFAULT '{}',
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.automation_execution_logs (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        automation_id INTEGER REFERENCES aisafe.automations(id) ON DELETE CASCADE,
    ...
    // notifications
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.notifications (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        user_id INTEGER NOT NULL REFERENCES aisafe.users(id) ON DELETE CASCADE,
        type aisafe.enum_notification_type,
        title VARCHAR(255),
        message TEXT,
        entity_type aisafe.enum_notification_entity_type,
        entity_id INTEGER,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.plugin_installations (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // llm_keys
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.llm_keys (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        key TEXT NOT NULL,
        name aisafe.enum_llm_keys_provider NOT NULL,
        url TEXT,
        model TEXT NOT NULL,
    ...
    // invitations
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.invitations (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        email VARCHAR(255) NOT NULL,
        name VARCHAR(255),
        surname VARCHAR(255),
        role_id INTEGER REFERENCES aisafe.roles(id),
        status VARCHAR(20) NOT NULL DEFAULT 'pending',
        invited_by INTEGER REFERENCES aisafe.users(id),
    ...
    // share_links
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.share_links (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // approval_workflows
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.approval_workflows (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.approval_workflow_steps (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        workflow_id INTEGER REFERENCES aisafe.approval_workflows(id) ON DELETE CASCADE,
    ...
    // approval_requests
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.approval_requests (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER NOT NULL REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        ...
        requested_by INTEGER REFERENCES aisafe.users(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.approval_request_steps (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        request_id INTEGER NOT NULL REFERENCES aisafe.approval_requests(id) ON DELETE CASCADE,
        step_number INTEGER NOT NULL,
        step_name VARCHAR(255) NOT NULL,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.approval_request_step_approvals (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        request_step_id INTEGER NOT NULL REFERENCES aisafe.approval_request_steps(id) ON DELETE CASCADE,
        approver_id INTEGER NOT NULL REFERENCES aisafe.users(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.approval_step_approvers (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        workflow_step_id INTEGER NOT NULL REFERENCES aisafe.approval_workflow_steps(id) ON DELETE CASCADE,
        approver_id INTEGER NOT NULL REFERENCES aisafe.users(id) ON DELETE CASCADE,
        created_at TIMESTAMP DEFAULT NOW(),
    ...
    // task_entity_links
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.task_entity_links (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        task_id INTEGER REFERENCES aisafe.tasks(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.policy_linked_objects (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        policy_id INTEGER REFERENCES aisafe.policy_manager(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.policy_manager__assigned_reviewer_ids (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        policy_manager_id INTEGER REFERENCES aisafe.policy_manager(id) ON DELETE CASCADE,
        user_id INTEGER REFERENCES aisafe.users(id) ON DELETE CASCADE,
    ...
    // dataset_projects
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.dataset_projects (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        dataset_id INTEGER REFERENCES aisafe.datasets(id) ON DELETE CASCADE,
        project_id INTEGER REFERENCES aisafe.projects(id) ON DELETE CASCADE,
        created_at TIMESTAMP DEFAULT NOW(),
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.dataset_model_inventories (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        dataset_id INTEGER REFERENCES aisafe.datasets(id) ON DELETE CASCADE,
        model_inventory_id INTEGER REFERENCES aisafe.model_inventories(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.model_inventories_projects_frameworks (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        model_inventory_id INTEGER REFERENCES aisafe.model_inventories(id) ON DELETE CASCADE,
        project_id INTEGER REFERENCES aisafe.projects(id) ON DELETE CASCADE,
        framework_id INTEGER REFERENCES aisafe.frameworks(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.vendor_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        vendor_id INTEGER,
        ...
        new_value TEXT,
        action VARCHAR(50),
        changed_by_user_id INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.vendor_risk_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.project_risk_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.policy_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        policy_id INTEGER,
        field_name VARCHAR(255),
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.incident_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        incident_id INTEGER,
        field_name VARCHAR(255),
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.use_case_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        use_case_id INTEGER,
        field_name VARCHAR(255),
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.model_inventory_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.model_risk_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // file_change_history
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.file_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        file_id INTEGER,
        field_name VARCHAR(255),
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.dataset_change_histories (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        dataset_id INTEGER,
        field_name VARCHAR(255),
    ...
    // task_change_history
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.task_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        task_id INTEGER,
        field_name VARCHAR(255),
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.training_change_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        training_id INTEGER,
        field_name VARCHAR(255),
    ...
    // risk_history
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.risk_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        parameter VARCHAR(255),
        snapshot_data JSONB,
        recorded_at TIMESTAMP DEFAULT NOW(),
        triggered_by_user_id INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
        created_at TIMESTAMP DEFAULT NOW()
      );
    `, { transaction });
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.model_inventory_history (
        id SERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        parameter VARCHAR(255),
        snapshot_data JSONB,
    ...
    // controls_eu__risks
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.controls_eu__risks (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        control_id INTEGER,
    ...
    // answers_eu__risks
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.answers_eu__risks (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        answer_id INTEGER,
        projects_risks_id INTEGER,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.subclauses_iso__risks (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.subclauses_iso27001__risks (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
        subclause_id INTEGER,
        projects_risks_id INTEGER,
        PRIMARY KEY (subclause_id, projects_risks_id)
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.annexcontrols_iso27001__risks (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.nist_ai_rmf_subcategories__risks (
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // ai_detection_scans
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_detection_scans (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          repository_url TEXT,
    ...
    // ai_detection_findings
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_detection_findings (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          scan_id INTEGER,
    ...
    // ai_detection_repositories
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_detection_repositories (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // ai_detection_risk_scoring_config
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_detection_risk_scoring_config (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // shadow_ai_tools
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.shadow_ai_tools (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          name VARCHAR(255) NOT NULL,
          vendor VARCHAR(255),
    ...
    // shadow_ai_events
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.shadow_ai_events (
          id BIGSERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          detected_tool_id INTEGER REFERENCES aisafe.shadow_ai_tools(id) ON DELETE SET NULL,
    ...
    // shadow_ai_daily_rollups
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.shadow_ai_daily_rollups (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          rollup_date DATE NOT NULL,
          tool_id INTEGER REFERENCES aisafe.shadow_ai_tools(id) ON DELETE CASCADE,
          user_email VARCHAR(255) NOT NULL,
          department VARCHAR(255),
          total_events INTEGER DEFAULT 0,
    ...
    // shadow_ai_monthly_rollups
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.shadow_ai_monthly_rollups (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // shadow_ai_rules
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.shadow_ai_rules (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          name VARCHAR(255) NOT NULL,
          description TEXT,
    ...
    // shadow_ai_alert_history
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.shadow_ai_alert_history (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          rule_id INTEGER REFERENCES aisafe.shadow_ai_rules(id) ON DELETE SET NULL,
    ...
    // shadow_ai_rule_notifications
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.shadow_ai_rule_notifications (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          rule_id INTEGER REFERENCES aisafe.shadow_ai_rules(id) ON DELETE CASCADE,
          user_id INTEGER REFERENCES aisafe.users(id) ON DELETE CASCADE,
          created_at TIMESTAMPTZ DEFAULT NOW(),
    ...
    // shadow_ai_settings
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.shadow_ai_settings (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          ...
          updated_by INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
          updated_at TIMESTAMPTZ DEFAULT NOW()
        );
      `, { transaction });
    ...
    // shadow_ai_syslog_config
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.shadow_ai_syslog_config (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          is_active BOOLEAN DEFAULT true,
    ...
    // shadow_ai_api_keys
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.shadow_ai_api_keys (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // ai_trust_center
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_trust_center (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          title VARCHAR(255),
          logo INTEGER,
    ...
    // ai_trust_center_intro
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_trust_center_intro (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // ai_trust_center_company_description
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_trust_center_company_description (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // ai_trust_center_compliance_badges
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_trust_center_compliance_badges (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // ai_trust_center_resources
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_trust_center_resources (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          name VARCHAR(255),
          description TEXT,
    ...
    // ai_trust_center_subprocessor
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_trust_center_subprocessor (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          name VARCHAR(255),
          purpose TEXT,
    ...
    // ai_trust_center_terms_and_contact
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ai_trust_center_terms_and_contact (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // evidence_hub
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.evidence_hub (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // api_tokens
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.api_tokens (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          name VARCHAR(255),
          token TEXT,
    ...
    // github_tokens
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.github_tokens (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // user_preferences
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.user_preferences (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          user_id INTEGER REFERENCES aisafe.users(id) ON DELETE CASCADE,
    ...
    // entity_graph_annotations
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.entity_graph_annotations (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          user_id INTEGER REFERENCES aisafe.users(id) ON DELETE CASCADE,
          entity_type VARCHAR(50),
    ...
    // entity_graph_views
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.entity_graph_views (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          user_id INTEGER REFERENCES aisafe.users(id) ON DELETE CASCADE,
          name VARCHAR(255),
    ...
    // entity_graph_gap_rules
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.entity_graph_gap_rules (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          user_id INTEGER REFERENCES aisafe.users(id) ON DELETE CASCADE,
          rules JSONB,
    ...
    // feature_settings
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.feature_settings (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      CREATE TABLE aisafe.audit_ledger (
        id BIGSERIAL PRIMARY KEY,
        organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      ...
      BEFORE DELETE ON aisafe.audit_ledger
      FOR EACH ROW EXECUTE FUNCTION aisafe.audit_ledger_prevent_delete();
    `, { transaction });

    await queryInterface.sequelize.query(`
      CREATE TRIGGER trg_audit_ledger_guard_update
      BEFORE UPDATE ON aisafe.audit_ledger
      FOR EACH ROW EXECUTE FUNCTION aisafe.audit_ledger_guard_update();
    `, { transaction });

    // policy_folder_mappings
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.policy_folder_mappings (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          policy_id INTEGER NOT NULL,
          folder_id INTEGER NOT NULL REFERENCES aisafe.virtual_folders(id) ON DELETE CASCADE,
          assigned_by INTEGER NOT NULL REFERENCES aisafe.users(id) ON DELETE CASCADE,
    ...
    // slack_webhooks
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.slack_webhooks (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // advisor_conversations
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.advisor_conversations (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          user_id INTEGER REFERENCES aisafe.users(id) ON DELETE CASCADE,
          domain VARCHAR(100),
    ...
    // file_access_logs
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.file_access_logs (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          file_id INTEGER,
          org_id INTEGER,
          accessed_by INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
          action VARCHAR(50),
    ...
    // ce_markings
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ce_markings (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          project_id INTEGER NOT NULL REFERENCES aisafe.projects(id) ON DELETE CASCADE,
    ...
    // ce_marking_conformity_steps
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ce_marking_conformity_steps (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // ce_marking_audit_trail
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ce_marking_audit_trail (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          ce_marking_id INTEGER NOT NULL,
          ...
          old_value TEXT,
          new_value TEXT,
          changed_by INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
          changed_at TIMESTAMP DEFAULT NOW(),
    ...
    // ce_marking_policies
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ce_marking_policies (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          ce_marking_id INTEGER NOT NULL,
          policy_id INTEGER NOT NULL,
    ...
    // ce_marking_evidences
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ce_marking_evidences (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          ce_marking_id INTEGER NOT NULL,
    ...
    // ce_marking_incidents
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.ce_marking_incidents (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          ce_marking_id INTEGER NOT NULL,
    ...
    // post_market_monitoring_configs
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.post_market_monitoring_configs (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          project_id INTEGER REFERENCES aisafe.projects(id) ON DELETE CASCADE,
          ...
          escalation_contact_id INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
    ...
    // post_market_monitoring_questions
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.post_market_monitoring_questions (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          config_id INTEGER REFERENCES aisafe.post_market_monitoring_configs(id) ON DELETE CASCADE,
    ...
    // post_market_monitoring_cycles
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.post_market_monitoring_cycles (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          config_id INTEGER REFERENCES aisafe.post_market_monitoring_configs(id) ON DELETE CASCADE,
          ...
          completed_at TIMESTAMP,
          completed_by INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
          assigned_stakeholder_id INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
          created_at TIMESTAMP DEFAULT NOW()
        );
      `, { transaction });
    ...
    // post_market_monitoring_responses
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.post_market_monitoring_responses (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          cycle_id INTEGER REFERENCES aisafe.post_market_monitoring_cycles(id) ON DELETE CASCADE,
          question_id INTEGER REFERENCES aisafe.post_market_monitoring_questions(id) ON DELETE CASCADE,
    ...
    // post_market_monitoring_reports
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.post_market_monitoring_reports (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          cycle_id INTEGER REFERENCES aisafe.post_market_monitoring_cycles(id) ON DELETE CASCADE,
          file_id INTEGER REFERENCES aisafe.files(id) ON DELETE SET NULL,
          context_snapshot JSONB NOT NULL DEFAULT '{}',
          generated_at TIMESTAMP DEFAULT NOW(),
          generated_by INTEGER REFERENCES aisafe.users(id) ON DELETE SET NULL,
          UNIQUE(cycle_id)
        );
      `, { transaction });
    ...
    // mlflow_integrations
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.mlflow_integrations (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // mlflow_model_records
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.mlflow_model_records (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    // intake_forms
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.intake_forms (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
          name VARCHAR(255) NOT NULL,
    ...
    // intake_submissions
      await queryInterface.sequelize.query(`
        CREATE TABLE aisafe.intake_submissions (
          id SERIAL PRIMARY KEY,
          organization_id INTEGER REFERENCES aisafe.organizations(id) ON DELETE CASCADE,
    ...
    await queryInterface.sequelize.query(`
      ...
      ON aisafe.ai_detection_scans (organization_id, repository_owner, repository_name)
    ...
    await queryInterface.sequelize.query(`
      ...
      ON aisafe.invitations(organization_id, email) WHERE status = 'pending';
    `, { transaction });
    ...
    await queryInterface.sequelize.query(`
      DO $$ BEGIN
        ALTER TABLE aisafe.ce_marking_conformity_steps ADD CONSTRAINT fk_ce_conformity_ce_marking FOREIGN KEY (ce_marking_id) REFERENCES aisafe.ce_markings(id) ON DELETE CASCADE;
      EXCEPTION WHEN duplicate_object THEN null; END $$;
    `, { transaction });
    await queryInterface.sequelize.query(`
      DO $$ BEGIN
        ALTER TABLE aisafe.ce_marking_audit_trail ADD CONSTRAINT fk_ce_audit_ce_marking FOREIGN KEY (ce_marking_id) REFERENCES aisafe.ce_markings(id) ON DELETE CASCADE;
      EXCEPTION WHEN duplicate_object THEN null; END $$;
    `, { transaction });
    await queryInterface.sequelize.query(`
      DO $$ BEGIN
        ALTER TABLE aisafe.ce_marking_policies ADD CONSTRAINT fk_ce_policies_ce_marking FOREIGN KEY (ce_marking_id) REFERENCES aisafe.ce_markings(id) ON DELETE CASCADE;
      EXCEPTION WHEN duplicate_object THEN null; END $$;
    `, { transaction });
    await queryInterface.sequelize.query(`
      DO $$ BEGIN
        ALTER TABLE aisafe.ce_marking_evidences ADD CONSTRAINT fk_ce_evidences_ce_marking FOREIGN KEY (ce_marking_id) REFERENCES aisafe.ce_markings(id) ON DELETE CASCADE;
      EXCEPTION WHEN duplicate_object THEN null; END $$;
    `, { transaction });
    await queryInterface.sequelize.query(`
      DO $$ BEGIN
        ALTER TABLE aisafe.ce_marking_incidents ADD CONSTRAINT fk_ce_incidents_ce_marking FOREIGN KEY (ce_marking_id) REFERENCES aisafe.ce_markings(id) ON DELETE CASCADE;
      EXCEPTION WHEN duplicate_object THEN null; END $$;
    `, { transaction });
    await queryInterface.sequelize.query(`
      DO $$ BEGIN
        ALTER TABLE aisafe.ce_marking_incidents ADD CONSTRAINT fk_ce_incidents_incident FOREIGN KEY (incident_id) REFERENCES aisafe.ai_incident_managements(id) ON DELETE CASCADE;
      EXCEPTION WHEN duplicate_object THEN null; END $$;
    `, { transaction });
    ...
    await queryInterface.sequelize.query(`
      DO $$ BEGIN
        ALTER TABLE aisafe.ai_detection_repositories ADD CONSTRAINT fk_ai_detection_repos_github_token FOREIGN KEY (github_token_id) REFERENCES aisafe.github_tokens(id) ON DELETE SET NULL;
      EXCEPTION WHEN duplicate_object THEN null; END $$;
    `, { transaction });
    ...
    await queryInterface.sequelize.query(`
      DO $$ BEGIN
        ALTER TABLE aisafe.projects
        ADD CONSTRAINT fk_projects_approval_workflow
        FOREIGN KEY (approval_workflow_id) REFERENCES aisafe.approval_workflows(id) ON DELETE SET NULL;
